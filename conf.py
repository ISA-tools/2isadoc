...
# -*- coding: utf-8 -*-
#
# 2isa documentation build configuration file, created by
...
project = '2isa'
copyright = '2016, Martin Larralde, Tom Lawson, Reza Salek'
author = 'Martin Larralde, Tom Lawson, Reza Salek'
